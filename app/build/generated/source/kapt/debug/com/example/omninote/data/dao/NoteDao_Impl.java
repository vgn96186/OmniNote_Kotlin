...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertAdapterOfNote = new EntityInsertAdapter<Note>() {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`title`,`content`,`createdAt`,`updatedAt`,`tags`,`isArchived`,`parentNoteId`,`positionX`,`positionY`,`width`,`height`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfNote = new EntityDeleteOrUpdateAdapter<Note>() {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notes` SET `id` = ?,`title` = ?,`content` = ?,`createdAt` = ?,`updatedAt` = ?,`tags` = ?,`isArchived` = ?,`parentNoteId` = ?,`positionX` = ?,`positionY` = ?,`width` = ?,`height` = ? WHERE `id` = ?";
      }
    ...
    return FlowUtil.createFlow(__db, false, new String[] {"notes"}, (_connection) -> {
      ...
      try {
        ...
        while (_stmt.step()) {
          ...
          _item = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpUpdatedAt,_tmpTags,_tmpIsArchived,_tmpParentNoteId,_tmpPositionX,_tmpPositionY,_tmpWidth,_tmpHeight);
          _result.add(_item);
        }
        return _result;
      } finally {
    ...
    return DBUtil.performSuspending(__db, true, false, (_connection) -> {
      ...
      try {
        ...
        if (_stmt.step()) {
          ...
          final float _tmpHeight;
          _tmpHeight = (float) (_stmt.getDouble(_columnIndexOfHeight));
          _result = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpUpdatedAt,_tmpTags,_tmpIsArchived,_tmpParentNoteId,_tmpPositionX,_tmpPositionY,_tmpWidth,_tmpHeight);
        } else {
          _result = null;
        }
        return _result;
  ...
  @Override
  public Object getNotesByTag(final String tag,
      final Continuation<? super List<Note>> $completion) {
  ...
  @Override
  public Object getChildNotes(final long parentId,
      final Continuation<? super List<Note>> $completion) {
  ...
  @Override
  public Object archiveNote(final long noteId, final Continuation<? super Unit> $completion) {
